...
public class DialogueShowerNetwork: NetworkBehaviour
{
    ...
    public void nextDialogue() {
        nextDialogueClientRpc();
    }

    [Command(requiresAuthority = false)]
    public void previousDialogue() {
        previousDialogueClientRpc();
    }

    [ClientRpc]
    public void nextDialogueClientRpc() {
    ...
    [ClientRpc]
    public void previousDialogueClientRpc() {
